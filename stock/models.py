...
class StockPrice(models.Model):
    ...
    moving_average_5 = models.IntegerField(null=True, blank=True)
    moving_average_20 = models.IntegerField(null=True, blank=True)
    moving_average_60 = models.IntegerField(null=True, blank=True)
    moving_average_120 = models.IntegerField(null=True, blank=True)
